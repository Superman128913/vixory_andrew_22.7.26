...
{
    public function getPlayingLevels()
    {
        $data = PlayingLevel::toObjectArray();
        return response()->json($data, 200);
    }

    public function getStates()
    {
        $data = StateCode::toObjectArray();
        return response()->json($data, 200);
    }

    public function getSchoolYears()
    {
        $data = UserDataSchoolYear::toObjectArray();
        return response()->json($data, 200);
    }

    /**
     * Manually copied from Laravel Nova's country field.
    ...
    public function getCountries()
    {
        ...
        return response()->json($reformatted_countries, 200);
    }
}
